export const translations = {
  zh: {
    ...
    'about.sectionAI': 'AI 在本应用中的运用',
    'about.aiIntro': '人工智能贯穿筑览的各个层面——从实时用户交互到构建时数据处理，再到内容创作。',
    'about.aiRuntimeHeading': '运行时 AI（应用内实时）',
    'about.aiScanTitle': '筑览识图 — 建筑扫描识别',
    'about.aiScanDesc': '本应用的核心 AI 功能。用户拍摄或上传任意中国历史建筑的照片，通义千问 VL（Qwen-VL-Max）即可识别建筑名称、朝代、类型及历史背景，并自动在地图上定位，展示详细历史信息。识别结果完整支持中英双语。',
    'about.aiBuildHeading': '构建时 AI（数据处理）',
    'about.aiTranslateTitle': '自动翻译（通义千问 Turbo）',
    'about.aiTranslateDesc': '数据获取脚本运行时，Qwen-Turbo 自动将 Wikidata 英文描述及人工整理词条的建筑说明、风格、特征、材料等字段批量翻译为中文，确保双语数据完整覆盖。',
    'about.aiContentHeading': '内容创作 AI',
    'about.aiDeepSeek': '历史研究、中文文本生成与代码辅助',
    'about.aiTongyi': '为人工整理词条生成 AI 建筑插图',
    'about.aiKimi': '文献综述、历史事实核查与长文档分析',
    'about.sectionTech': '技术栈',
    'about.techFramework': '框架',
    'about.techMap': '地图',
    'about.techCharts': '图表',
    'about.techStyling': '样式',
    'about.techData': '数据',
    'about.techDeployment': '部署',
  ...
  en: {
    ...
    'about.sectionAI': 'How AI Powers This App',
    'about.aiIntro': 'AI is woven through every layer of ZhuLan — from real-time user interactions to build-time data enrichment and content creation.',
    'about.aiRuntimeHeading': 'Runtime AI (live in the app)',
    'about.aiScanTitle': 'Scan & Discover — 筑览识图',
    'about.aiScanDesc': "The app's centrepiece AI feature. A user photographs or uploads any Chinese historical structure and Tongyi Qwen-VL-Max identifies the building — name, dynasty, type, and historical context — then flies to its location on the map and displays rich bilingual history. Results are returned fully in both Chinese and English.",
    'about.aiBuildHeading': 'Build-time AI (data pipeline)',
    'about.aiTranslateTitle': 'Automatic Translation (Qwen-Turbo)',
    'about.aiTranslateDesc': 'When the data fetch script runs, Qwen-Turbo batch-translates all English descriptions from Wikidata and hand-curated fields (architect, style, key features, materials) into Chinese in a single API call, ensuring complete bilingual coverage across the dataset.',
    'about.aiContentHeading': 'Content creation AI',
    'about.aiDeepSeek': 'Historical research, Chinese text generation, and code assistance',
    'about.aiTongyi': 'AI-generated structure illustrations for curated entries',
    'about.aiKimi': 'Literature review, historical fact-checking, and long-document analysis',
    'about.sectionTech': 'Tech Stack',
    'about.techFramework': 'Framework',
    'about.techMap': 'Map',
    'about.techCharts': 'Charts',
    'about.techStyling': 'Styling',
    'about.techData': 'Data',
    'about.techDeployment': 'Deployment',
